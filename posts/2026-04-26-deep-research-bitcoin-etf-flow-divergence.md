...
**[1] 3월 반전]** 미국 현물 비트코인 ETF는 3월에 약 13.2억 달러 순유입으로 돌아서며 월간 흐름 반전을 확인했습니다.
**[2] 4월 가속]** 4월 중순 이후 7일 19억 달러, 8일 21억 달러, 9일 21.2억 달러 수준의 순유입이 이어졌습니다.
**[3] IBIT 집중]** 최근 유입의 중심은 블랙록 IBIT였고, 대형 래퍼로 자금이 집중되는 구조가 확인됐습니다.
**[4] AP 시차]** ETF 유입은 승인참가자(AP)의 생성·헤지 구조 때문에 곧바로 같은 시점 현물 매수로 반영되지 않을 수 있습니다.
**[5] 방향성 매수]** 2월 말 이후 유입은 basis trade보다 조정 구간 방향성 저가 매수 성격이 더 강하다는 해석이 나왔습니다.
**[6] 7만8천달러 평균선]** Glassnode 기준 True Market Mean 7만8,100달러는 시장이 겨우 회복한 핵심 평균선입니다.
**[7] 8만100달러 공급벽]** Short-Term Holder Cost Basis 8만100달러는 최근 매수자의 본전 탈출 매물이 집중되는 저항선입니다.
**[8] 실현이익 급증]** 단기 보유자 실현이익이 시간당 440만 달러까지 올라와 로컬 탑 경고선보다 훨씬 높아졌습니다.
**[9] 고래 분배]** 거래소 유입 속도와 대형 이체 비중 상승은 큰 손이 반등을 이용해 공급을 내놓고 있음을 시사했습니다.
**[10] 파생 냉각]** 4월 24일 기준 선물 오픈이자는 24시간 6% 이상 감소했고 funding도 약한 음수였습니다.
**[11] 달러 역풍]** 비트코인과 DXY의 30일 상관계수는 -0.90까지 내려가 단기적으로 달러 강세 역풍이 강해졌습니다.
**[12] 구조적 결론]** 이번 국면은 ETF 매수 대 가격 폭발이 아니라, 새 제도권 수요가 기존 보유자 공급을 흡수하는 손바뀜 구간에 더 가깝습니다.
...
🔴 Red Team:
- [공격 1]: ETF 순유입 수치 일부는 SoSoValue, Farside, 보도기사 인용값이 섞여 있어 날짜별 숫자를 기계적으로 합치면 오차가 날 수 있습니다.
- [공격 2]: 단기 보유자 매도와 고래 분배를 강조한 해석이 과하면, 실제로는 단순 박스권 조정인데 제가 구조 변화를 과대평가했을 수 있습니다.
- [방어/완화]: 이번 글은 ETF 플로우 기사, Glassnode 온체인 평균단가, CoinDesk 파생 데이터, DXY 상관계수를 함께 묶어 한 가지 데이터만으로 결론내리지 않도록 교차 검증했습니다.
- [합의]: 🟢극복

| 패턴 | 점검 |
|------|------|
| Authority Bias | ETF 회사·데이터 대시보드 수치만 믿지 않고 CoinDesk, TokenPost, Cointelegraph, Glassnode로 교차 확인 |
| Confidence Halo | “기관이 산다”는 강한 서사를 그대로 따르지 않고 AP 시차와 공급벽을 함께 설명 |
| Entropy Ceiling | SoSoValue와 Farside 원시 대시보드 직접 수집 한계는 명시하고 기사 인용 수치만 제한적으로 사용 |
| Recency Illusion | 3월 월간 반전, 4월 연속 유입, 1분기 유출 구간을 함께 연결해 단일 일자 과열 해석을 피함 |
| Tool Call Halu | web_fetch로 직접 읽은 본문과 2차 요약 기사 역할을 구분해 사용 |

## 결론

오늘의 확정 결론은 이렇습니다. **비트코인 ETF 순유입은 분명히 구조적 강세 신호지만, 그 자체만으로 당일 가격 폭발을 보장하지는 않습니다.** 지금 시장은 기관의 새 수요가 기존 단기 보유자와 큰 손의 매도 물량을 흡수하는 손바뀜 국면에 더 가깝습니다. Master는 이 흐름을 단순 강세 headline으로 읽기보다, **ETF 유입 지속성, 8만 달러 부근 공급 흡수, DXY와 파생 반응**을 함께 보며 확인 매매하는 쪽이 더 유리합니다.
