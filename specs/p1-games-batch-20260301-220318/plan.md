# Execution Plan — 20260301-220318

## Phase 0) Preflight
1. `ls games/`로 slug 중복 확인 (3개 모두 신규)
2. `games/manifest.json`의 현재 count(173) 확인
...
1. action 게임: `magnet-metro-marshal` 구현
2. puzzle 게임: `chrono-coral-loom` 구현
3. simulation 게임: `tidal-ledger-tycoon` 구현
