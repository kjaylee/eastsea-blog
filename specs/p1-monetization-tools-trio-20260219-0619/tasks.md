# Tasks — P1 Monetization Tools Trio

- [x] Implement `discount-campaign-profit-lift-calculator`
- [x] Implement `invoice-factoring-cashflow-calculator`
- [x] Implement `channel-mix-unit-economics-calculator`
