...
## A. 구조/요건
- [x] 3개 슬러그 경로에 `index.html` 존재
- [x] 각 도구에 `<title>`, `meta description`, `href='/'` Back to Portal 링크 존재
- [x] 모바일 폭(360px)에서 단일 컬럼으로 입력/결과 사용 가능
...
## C. 통합/배포
- [x] `tools/manifest.json`에 신규 3개 slug 포함
- [x] `_data/tools-list.json`에 신규 3개 URL 포함
- [x] 배포 URL 3개 HTTP 200 확인
