# Execution Plan — p1y-games-batch-20260301-202157

## Phase 0) Preflight
1. `ls games/`로 slug 중복 확인 (3개 모두 신규)
2. `games/manifest.json`의 현재 count(152) 확인
...
1. rhythm 게임: `sonic-loom-switchyard` 구현
2. action 게임: `abyssal-archive-diver` 구현
3. simulation 게임: `voltaic-kite-rigger` 구현
