# Execution Plan — p1z-games-batch-20260301-203940

## Phase 0) Preflight
1. `ls games/`로 slug 중복 확인 (3개 모두 신규)
2. `games/manifest.json`의 현재 count(158) 확인
...
1. puzzle 게임: `quantum-quilt-cascade` 구현
2. action 게임: `semaphore-sandbar-salvage` 구현
3. simulation 게임: `hologram-habitat-triage` 구현
