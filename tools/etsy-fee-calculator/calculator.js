(function (root) {
  ...
  const I18N = {
    ko: {
      title: "🧾 Etsy 수수료 계산기",
      subtitle: "Etsy listing fee, 6.5% transaction fee, payment processing, Offsite Ads를 먼저 계산하고, Etsy 수수료 차감 후 payout과 판매자 비용 반영 후 남는 금액까지 바로 보여줍니다.",
      back: "← Tools",
      inputHeader: "입력값",
      kpiHeader: "핵심 KPI",
      detailHeader: "세부 지표",
      ...
      assumptionNote: "This Etsy Fee Calculator leads with the listing fee, 6.5% transaction fee, payment processing, and Offsite Ads. Listing fee는 옵션을 켠 경우 0.20 × 수량으로 반영하고, Offsite Ads는 12% / 15% / custom + 주문당 최대 $100 한도로 계산합니다.",
      aboutCopy: "Use this Etsy Fee Calculator to estimate the listing fee, 6.5% transaction fee, payment processing, and Offsite Ads drag on each order. It keeps the sibling tool's fee formula parity, then shows payout after Etsy fees and net profit as secondary outputs.",
    ...
    en: {
      ...
      subtitle: "Estimate listing fee, the 6.5% transaction fee, payment processing, Offsite Ads, payout after Etsy fees, and what remains after seller-side costs.",
      back: "← Tools",
      inputHeader: "Inputs",
      kpiHeader: "Key KPIs",
