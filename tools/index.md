...
- [Spotify Royalty Calculator | Spotify 로열티 계산기](./spotify-royalty-calculator/) — 월간 Spotify 스트림 수, 스트림당 가정 지급액, 아티스트 지분, 배급사 수수료, 협업자 배분, 고정비를 반영해 총 로열티, 실수령액, 1,000 연간 스트림 기준, 목표 수익 달성 필요 스트림 수를 계산합니다.
